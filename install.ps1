...
function Get-LatestRelease {
    $releaseUrl = "https://api.github.com/repos/base-al/admin-cli/releases/latest"
    try {
...
Write-Host "Installing BUI CLI..." -ForegroundColor Green
...
$installDir = Join-Path $env:USERPROFILE ".bui"
...
# Download URL
$downloadUrl = "https://github.com/base-al/admin-cli/releases/download/$version/base_windows_$arch.zip"
...
try {
    ...
    Write-Host "`nBUI CLI has been installed successfully!" -ForegroundColor Green
    
    # Install Go dependencies
    Write-Host "`nInstalling BUI CLI dependencies..." -ForegroundColor Yellow
